...
import { X, Send, Phone, ConciergeBell, CheckCircle2, AlertCircle, RefreshCw } from "lucide-react";
                  ...
                  {messages.map((msg) => (
                    <div key={msg.id} className="space-y-2">
                      {msg.parts.map((part, partIndex) => {
                        ...
                        {/* Render the book_reservation tool lifecycle */}
                ...
                <form onSubmit={handleSubmit} className="p-4 bg-redz-charcoal border-t border-redz-charcoal-light">
                  <div className="relative flex items-center gap-2">
                    <button
                      ...
                      className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center transition-colors bg-redz-charcoal-light border border-gray-800 text-gray-400 hover:text-redz-accent hover:border-redz-accent group cursor-pointer"
